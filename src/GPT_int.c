...
void R_GPT123_Create(void)
{
	...
	* clearing the module stop bit to ensure the timer is stopped before proceeding with configuration. */
	...
	//
	R_GPT1->GTINTAD_b.GRPABL = 0x01;	//Simultaneous low output stop detection is enabled
	R_GPT2->GTINTAD_b.GRPABL = 0x01;
	R_GPT3->GTINTAD_b.GRPABL = 0x01;	//Simultaneous low output stop detection is enabled

//	R_GPT1->GTIOR_b.OADF = 0x02;		//GPTIOC0B output enable
//	R_GPT1->GTIOR_b.OBDF = 0x02;		//GPTIOC0B output enable
//	R_GPT2->GTIOR_b.OADF = 0x02;		//GPTIOC0B output enable
//	R_GPT2->GTIOR_b.OBDF = 0x02;		//GPTIOC0B output enable
//	R_GPT3->GTIOR_b.OADF = 0x02;		//GPTIOC0B output enable
//	R_GPT3->GTIOR_b.OBDF = 0x02;		//GPTIOC0B output enable
